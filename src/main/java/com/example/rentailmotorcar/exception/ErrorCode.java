...
public enum ErrorCode {
   ...
   VEHICLE_NOT_FOUND(1019,"Vehicle not found",HttpStatus.NOT_FOUND),
   REVIEW_NOT_FOUND(1020,"Review not found",HttpStatus.NOT_FOUND),
   RENTED_VEHICLE(1021,"Vehicle not vailid",HttpStatus.BAD_REQUEST),
   ...
   BRAND_NOT_NULL(1025,"Brand not Valid",HttpStatus.BAD_REQUEST),
